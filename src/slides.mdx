...
<iframe src="https://giphy.com/embed/13t8qWO16fHw9W" style={{width: '50%', margin: '0 auto'}} height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p className="caption" style={{margin: 0, textAlign: 'center'}}><a href="https://giphy.com/gifs/grid-13t8qWO16fHw9W" style={{fontSize: '16px'}}>via GIPHY</a></p>
...
<p style={{textAlign: 'center'}}>There must be a better way to align nested grids... 🤔</p>
