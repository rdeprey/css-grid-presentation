...
<p style={{ textAlign: 'center' }}>March 17, 2020</p>

<iframe
  src='https://giphy.com/embed/13t8qWO16fHw9W'
...
<p className='caption' style={{ margin: 0, textAlign: 'center' }}>
  <a
    href='https://giphy.com/gifs/grid-13t8qWO16fHw9W'
    style={{ fontSize: '16px' }}>
    via GIPHY
  </a>
</p>
...
<iframe src="https://giphy.com/embed/3oz8xtBx06mcZWoNJm" style={{width: '100%'}} height="270" frameBorder="0" className="giphy-embed" allowFullScreen></iframe><p className="caption" style={{marginTop: 0, textAlign: 'center'}}><a href="https://giphy.com/gifs/supersimple-train-tracks-NsESN6J13laGW6eTIx" style={{fontSize: '16px'}}>via GIPHY</a></p>
</SplitLayoutLeft>
...
<small className='caption' style={{ fontSize: '20px', textAlign: 'center' }}>
  Grid Lines
</small>

<img
  src={gridLineExample2}
  alt='Grid lines'
  style={{ width: '60%', margin: '5px auto 15px' }}
/>
...
- Spaces between columns and rows are _grid gaps_
...
- Grids have two axes that we can use to align grid items - **inline** and **block**
- Inline axis:
...
- You target a **line** when placing items, not a **track**
...
Prioritizes items with **row start** or **row end** property. Other items are then flowed in around it using the normal flow.

<small className='caption' style={{ fontSize: '20px', textAlign: 'center' }}>
  <em>Row start</em> and <em>row end</em> properties not defined
</small>
<img
  src='https://gedd.ski/gif/grid-item-placement/1.gif'
  alt='Row auto-flow grid placement'
  style={{ width: '70%', margin: '5px auto 25px' }}
/>

<small className='caption' style={{ fontSize: '20px', textAlign: 'center' }}>
  <em>Row start</em> and <em>row end</em> properties defined
</small>
<img
  src='https://gedd.ski/gif/grid-item-placement/3.gif'
  alt='Item placement in grids with grid-auto-flow: row'
...
- Prioritizes items with **column start** or **column end** property defined
...
- With `stack` option, algorithm looks for first empty cell and places all **auto** positioned items in that cell (regardless of size), stacked on top of each other.
...
**Alignment of the nested grid items with the parent grid becomes difficult**
...
<iframe
  src='https://giphy.com/embed/wMNK4IfeH86uQ'
  style={{ width: '100%' }}
  height='259'
  frameBorder='0'
  className='giphy-embed'
...
<p style={{ textAlign: 'center', margin: 0 }}>
  <a
    href='https://giphy.com/gifs/funny-willy-wonka-and-the-chocolate-factory-wMNK4IfeH86uQ'
    style={{ fontSize: '16px' }}>
    via GIPHY
  </a>
</p>
